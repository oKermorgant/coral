...
osg::Node* Scene::loadIslands(const std::string& terrain_shader_basename)
{
    ...
    std::cout << "island @ " << island.get() << std::endl;
...
osg::ref_ptr<osg::TextureCubeMap> Scene::loadCubeMapTextures( const std::string& dir )
{
    ...
    filenames[POS_X] = dir + "/east.png";
    filenames[NEG_X] = dir + "/west.png";
    filenames[POS_Z] = dir + "/north.png";
    filenames[NEG_Z] = dir + "/south.png";
    filenames[POS_Y] = dir + "/down.png";
    filenames[NEG_Y] = dir + "/up.png";
